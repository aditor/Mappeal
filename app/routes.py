...
@app.route('/search')
def search():
    print("this is the city" + request.args.get('city', default = "",type = str))
    ...
    json.dumps(finalDict, ensure_ascii=True)
    # print(str(places))
    ...
    user = {'username': 'TEST!'}
    return render_template('index.html', title='TEST', placeArr=finalDict)
